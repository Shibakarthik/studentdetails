...
if(isset($_POST['name'])){
   ...
   // mysql_select_db('database',$con) or die(mysql_error());
    ...
    $sql = "INSERT INTO `studentdetails` (`Roll.NO`, `Name`, `Class`, `D.O.B`, `Age`, `Phone Number`, `Email`, `Address`, `Gender`, `Blood Group`)VALUES ('$eno','$name', '$class', '$dob', '$age','$phone','$email', '$address', '$gender', '$bloodgroup' );";
